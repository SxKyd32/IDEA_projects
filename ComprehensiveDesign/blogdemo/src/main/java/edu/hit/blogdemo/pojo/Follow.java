...
public class Follow {
    ...
    private Byte status;
    private Timestamp followCreatTime;
    ...
    @Basic
    @Column(name = "follow_creat_time")
    public Timestamp getFollowCreatTime() {
        return followCreatTime;
    }

    public void setFollowCreatTime(Timestamp followCreatTime) {
        this.followCreatTime = followCreatTime;
    }
}
